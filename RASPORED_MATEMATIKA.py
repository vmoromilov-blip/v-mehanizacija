...
# UVOZIMO NAŠU PRVU PROČIŠĆENU FIOKU ZA OKRETANJE SMENA
...
def izracunaj_troslojni_raspored(fajl_baze):
    ...
    # --- SLOJ 1: TURNUS MOTOR (Povezan sa našom novom pod-fasciklom) ---
    ...
    # --- SLOJ 2: Filter ispravnosti (Briše ljude ako mašina leži ili je u kvaru) ---
    ...
    # --- SLOJ 3: Vojna naredba iz Zamena (Sečenje u milimetar tačno u dan) ---
