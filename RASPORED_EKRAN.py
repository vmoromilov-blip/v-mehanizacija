...
# UVOZIMO POZADINSKU SKRETNICU KOJA POVEZUJE TVOJA TRI SLOJA
...
def prikazi_raspored(fajl_baze):
    ...
    # Prisilno čistimo stare privremene fajlove iz memorije servera
    ...
    # Računamo raspored iz pročišćene pozadinske matematike (Tačno 9 dana)
    ...
    # --- KONTROLNA TABLA: Krupno dugme sa kalendarom na vrhu ekrana ---
    ...
    # STROGO I BEZUSLOVNO HRONOLOŠKO REĐANJE: Slažemo dane prirodno sleva nadesno
    ...
    # 🚀 ZAKLJUČAN I SVEŽ KLJUČ v12 ZA POTPUNI RESET PRIVREMENE MEMORIJE TABELE
    st.data_editor(
        df,
        ...
        disabled=True,
        key="editor_troslojnog_rasporeda_skraceni_mirni_final_v12"
    )
